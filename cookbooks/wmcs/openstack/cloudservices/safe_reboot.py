r"""WMCS openstack - Safely reboot a cloudservices node.

Usage example: wmcs.openstack.cloudservices.safe_reboot \
...
from wmcs_libs.openstack.batch import CloudservicesBatchBase, CloudservicesBatchRunnerBase


class SafeReboot(CloudservicesBatchBase):
    __doc__ = __doc__
...
class SafeRebootRunner(CloudservicesBatchRunnerBase):
